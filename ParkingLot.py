...
class ParkingLot(object):
    ...
    def parkThePark(self,slotId, registrationNumber,age):
        ...
        if self.__slots[slotindex].checkIfCarParked() == True:
            print("Car with vehicle registration number",'"',registrationNumber.strip(),'"',"has been parked at slot number",slotId)
    ...
    def leaveTheCar(self, slotId):
        ...
        if self.__slots[slotindex].checkIfCarParked() == False:
            print('Slot number {} vacated, the car with vehicle registration number " PB-01-HH-1234 " left the space, the driver of the car was of age 21'.format(slotId))
